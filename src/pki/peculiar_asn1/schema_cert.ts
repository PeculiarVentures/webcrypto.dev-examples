...
async function main() {
  const raw = Buffer.from([
    ...
    "QDvC_kKGsMuGDAIlsysMH1tGl4V3lYYKbJ93mZkBVvlooaaJ_0GEekWMiM4h4QWp",
    "SDEc5XYEj6g1j_nDlfM0Hvp_1qxCTOECRmbmDQTJfumHvZtHKR6fdh2nfXb1A_b7",
    "65KOTzzlxZ1Tdl6HPwo8NB5H5pPrhunX1cVYyLxs2q6Icw-8Bj5O5HuzRElQf772",
    "6aicVs34bb25R7ZYgfII8mfA1DK6Ns0xU456GsuKSpEPD_rzye8b2w2GLdimjwB8",
    "vmxZDwHB_z4AmAaR349gbzcdUPv2LhfnYRUCAwEAAaMPMA0wCwYDVR0PBAQDAgCA",
    "MA0GCSqGSIb3DQEBCwUAA4IBAQAQ3Vv6V1Be2FOavJDENBf5G_mQ01Jq1MCD-qvW",
    "XKf3GHzjv_Y-0Kb-tiEXhOfNPApxFJ9v5lzwkfyPutYipSEKvAt61EeGBCpacrW5",
    "qo52-i9U0R0i3rQVZTe4S7eUMujoXFM8aqbRe_ISJ9bH0NK4pU8yhPpA3AJJHcC-",
  ...
  // Create new Certificate instance from the raw array
  const cert = asn1.AsnConvert.parse(raw, Certificate);

  // Output the Certificate instance
  console.log(cert);
  // Certificate {
